...
public class RingButton extends View {
    ...
    private int circleColor = Color.WHITE; //#FF5722 //rgba(255, 87, 34, 1)
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        if (null != attrs) {
            ...
            circleColor = typedArray.getColor(R.styleable.ringButton_ringbutton_circleColor, Color.parseColor("#FF5722"));
